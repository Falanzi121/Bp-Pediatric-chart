...
infant_bp_data = {
    ...
    12: {'SBP': (94, 103, 95, 104), 'DBP': ( Fifty50, 65,  Fifty50, 66)}  # 12 months: ~ male 85-103, female 86-104 [oai_citation:40‡childrensmercy.org](https://www.childrensmercy.org/siteassets/media-documents-for-depts-section/documents-for-health-care-providers/evidence-based-practice/clinical-practice-guidelines--care-process-models/normal-blood-pressures-by-age.pdf#:~:text=Infant%20,to%2058%2042%20to%2061)
}
